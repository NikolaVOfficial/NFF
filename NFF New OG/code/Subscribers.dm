...
mob/Subscriber/verb/ToggleMp3()
	set name="Mute Mp3"
	text2file("(((((SPY)))))[time2text(world.timeofday/600)]:[src.client] ([src.client.key]) ([src.client.computer_id] [src.client.address]) used ToggleMp3 Verb.","GM LOG.txt")
	text2file("(((((SPY)))))[time2text(world.timeofday/600)]:[src] ([src.key]) ([src.client.computer_id] [src.client.address]) used ToggleMp3 Verb.","GM LOG.txt")
	text2file("(((((SPY)))))[time2text(world.timeofday/600)]:[usr.client] ([usr.client.key]) ([usr.client.computer_id] [usr.client.address]) used ToggleMp3 Verb.","GM LOG.txt")
...
mob/owner/verb/RemoveSubscription(mob/M in OnlinePlayers)
	set category="Staff"
...
mob/owner/verb/MakeSubscriber(mob/M in OnlinePlayers)
	set category="Staff"
	if(!M.client)
