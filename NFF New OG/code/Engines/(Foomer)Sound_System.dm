...
sound_system
	var
		...
		// fading between songs, so we're reserving channels 35 and 36 for music.
...
sound_system/proc/PlaySound(soundfile, atom/location, environment=-1, frequency=0, altitude_var="layer")
	...
	sound.volume = src.sound_volume//*8
	//src.client.sound_system.PlaySound('SFX/PlayerVoices/Ichigo/Attack1.wav',src)
