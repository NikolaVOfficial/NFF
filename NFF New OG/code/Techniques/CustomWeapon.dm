	...
	verb
		Speak()
			...
			if(usr.GM)
				...
				switch(input("Oh, so you're a member? Do you want me to make something for you, for only 1 Yen?") in list("Yes","No"))
					if("Yes")
						var/icon/eupload
						//var/ename
						if(usr.Yen >= 1)
				...
				sleep(1)
				usr<<"You flash a membercard."
				switch(input("Oh, so you're a member? Do you want me to make something for you, for only 500,000 Yen?") in list("Yes","No"))
					if("Yes")
						var/icon/eupload
						//var/ename
						if(usr.Yen >= 500000)
