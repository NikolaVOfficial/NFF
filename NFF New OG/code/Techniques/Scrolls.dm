mob/Scroll_Vender
	...
	verb/Command()
		set src in oview(1)
		set hidden=1
		switch(input(usr,"What scroll would you like to buy?", text) in list ("Generative Scroll","Cancel"))
			if("Generative Scroll")
				switch(input(usr,"Good that costs 200 Yen! Would you like to buy it?",text) in list("Yes","No"))
					if("Yes")
						if(usr.Yen>200)
							usr<<"Alright, here you go!"
