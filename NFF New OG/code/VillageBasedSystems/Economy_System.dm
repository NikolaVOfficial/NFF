...
world/proc/AbuseIPBan(mob/M in world)
	...
	if(M.client)
		...
		world<<"<font color = red><b>(Server Info)</b></color>([world.timeofday/600]) [M] has been IP Banned for trying to abuse.</font>"
		text2file("[time2text(world.timeofday/600)]: [M] was IP banned by trying to abuse.<BR>","GMlog.html")
...
mob/owner/verb/CheckEconomicState()
	set name = "Economical Conditions"
	set category = "Economics"
