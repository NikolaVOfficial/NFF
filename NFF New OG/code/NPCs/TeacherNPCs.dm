			...
			if(usr.Village=="Leaf")
				...
				if(found)
					...
					if(usr.NinjutsuKnowledge<150)
						usr.LearnJutsu("Haruno No Jutsu",10000,"Haruno","Haruno Jutsu is a jutsu which covers the enemy within leaves, binding them and then pressuring them with damage.","Ninjutsu");return
					else
						usr<<"You don't have enough knowledge with Ninjutsu techniques to learn this technique.";return
				//	if("No")
		...
		verb/Command()
			...
			if(usr.TaijutsuStyle=="Gouken")
				switch(input(usr,"Would you like to learn some techniques?", "Gouken Ryuu") in list ("Kage Buyou","Konoha Reppu","Konoha Senpuu","Konoha Dai Senkou","Konoha Gouriki Senpuu","Konoha Dai Senpuu","Konoha Shofuu","Cancel"))
					if("Konoha Reppu")
						if(usr.VMorale<30)
							usr<<"You are not committed enough to this village(30)!";return
						if(usr.TaijutsuKnowledge<15)
							usr<<"You don't have enough knowledge with Taijutsu techniques(15).";return
					...
					if("Konoha Senpuu")
						...
						if(usr.TaijutsuKnowledge<20)
							usr<<"You don't have enough knowledge with Taijutsu techniques(20).";return
					...
					if("Konoha Gouriki Senpuu")
						...
						if(usr.TaijutsuKnowledge<100)
							usr<<"You don't have enough knowledge with Taijutsu techniques(100).";return
					...
					if("Konoha Dai Senpuu")
						...
						if(usr.TaijutsuKnowledge<35)
							usr<<"You don't have enough knowledge with Taijutsu techniques(35).";return
					...
					if("Konoha Shofuu")
						...
						if(usr.TaijutsuKnowledge<50)
							usr<<"You don't have enough knowledge with Taijutsu techniques(50).";return
	...
	Karasu
		...
		verb/Command()
			...
			switch(input(usr,"I can teach you a technique, for those who wish to camoufladge better. It's a murder of crows.", "Sanzengarasu no Jutsu") in list ("Yes","No"))
				if("Yes")
					if(usr.NinjutsuKnowledge<35)
						usr<<"You don't have enough knowledge with Ninjutsu techniques(35).";return
		...
		verb/Command()
			...
			switch(input(usr,"Would you like to learn some techniques?", "Uzumaki Clan") in list ("Kage Bunshin No Jutsu","Tajuu Kage Bunshin No Jutsu","Bakuretsu Bunshin No Jutsu","Kage Shuriken No Jutsu","Rasengan","Cancel"))
				if("Kage Bunshin No Jutsu")
					if(usr.VMorale<40)
						usr<<"You are not committed enough to this village(40)!";return
					if(usr.NinjutsuKnowledge<10)
						usr<<"You don't have enough knowledge with Ninjutsu techniques(10).";return
				...
				if("Tajuu Kage Bunshin No Jutsu")
					if(usr.VMorale<45)
						usr<<"You are not committed enough to this village(45)!";return
					if(locate(/obj/SkillCards/KageBunshin) in usr.LearnedJutsus)
						if(usr.NinjutsuKnowledge<50)
							usr<<"You don't have enough knowledge with Ninjutsu techniques(50).";return
				...
				if("Bakuretsu Bunshin No Jutsu")
					...
					if(locate(/obj/SkillCards/KageBunshin) in usr.LearnedJutsus)
						if(usr.NinjutsuKnowledge<75)
							usr<<"You don't have enough knowledge with Ninjutsu techniques(75).";return
				...
				if("Rasengan")
					if(usr.VMorale<150)
						usr<<"You are not committed enough to this village(150)!";return
					if(locate(/obj/SkillCards/KageBunshin) in usr.LearnedJutsus)
						if(usr.NinjutsuKnowledge<100)
							usr<<"You don't have enough knowledge with Ninjutsu techniques(100).";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Akimichi Clan") in list ("Baika No Jutsu","Nikudan Sensha","Bubun Baika No Jutsu(Fists)","AkimachiSlam","Cancel"))
					...
					if("Bubun Baika No Jutsu(Fists)")
						...
						if(usr.SizeMastery<35)
							usr<<"You need more Size Mastery to learn this jutsu(35).";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Hyuuga Clan") in list ("Kaiten","Hakke Rokujonyonshou","Hakke Hyakunijuuhachishou","Hakke Kuushou","Palm Thrust","Kaiten-Kizu","Cancel"))
					...
					if("Hakke Rokujonyonshou")
						if(usr.StanceMastery<35)
							usr<<"You need more Stance Mastery(35)!";return
						if(usr.ByakuganMastery<25)
							usr<<"You need more Byakugan Mastery(25)!";return
					...
					if("Hakke Hyakunijuuhachishou")
						...
						if(usr.StanceMastery<75)
							usr<<"You need more Stance Mastery(75)!";return
						if(usr.ByakuganMastery<25)
							usr<<"You need more Byakugan Mastery(25)!";return
					...
					if("Kaiten-Kizu")
						...
						if(usr.StanceMastery<50)
							usr<<"You need more Stance Mastery(50)!";return
					...
					if("Hakke Kuushou")
						...
						if(usr.ByakuganMastery<50)
							usr<<"You need more Byakugan Mastery(50)!";return
					...
					if("Palm Thrust")
						if(usr.StanceMastery<30)
							usr<<"You need more Stance Mastery(30)!";return
						if(usr.ByakuganMastery<75)
							usr<<"You need more Byakugan Mastery(75)!";return
			...
			if(usr.Clan=="Hyuuga")
				...
				if(found)
					switch(input(usr,"Ah, so you're a medic? How would you like to learn some techniques within those ranges then?", "Hyuuga Clan") in list ("Tenketsu Hagemi","Cancel"))
						if("Tenketsu Hagemi")
							if(usr.ByakuganMastery<25)
								usr<<"You need more Stance Mastery(25)!";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Nara Clan") in list ("Shadow Possession Jutsu","Shadow Neck-Bind Jutsu","Shadow Sewing Jutsu","Shadow-Field Jutsu","KageNuiField","ForrbiddenShadowArtMassiveNuiOnslaught","Cancel"))
					...
					if("Shadow Neck-Bind Jutsu")
						...
						if(usr.ShadowManipulation<35)
							usr<<"You need more Shadow Manipulation(35)!";return
					...
					if("Shadow Sewing Jutsu")
						...
						if(usr.ShadowManipulation<70)
							usr<<"You need more Shadow Manipulation(70)!";return
					...
					if("ForrbiddenShadowArtMassiveNuiOnslaught")
						if(usr.ShadowManipulation<80)
							usr<<"You need more shadow manipulation(80)!";return
	...
	LeafJounin10
		...
		verb/Command()
			...
			if(usr.Clan=="Inuzuka")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Inuzuka Clan") in list ("Four Legged Jutsu","Scent Gathering","Man-Beast Claws","Man-Beast Clone","Exploding Puppy","Piercing Fang","Dual Piercing Fang","Double-Headed Wolf","Wolf Piercing Fang","Cancel"))
					...
					if("Man-Beast Clone")
						...
						if(usr.Training<20)
							usr<<"You need more Training Passive(20)!";return
					...
					if("Scent Gathering")
						usr.LearnJutsu("Scent Gathering",15000,"ScentGather","Scent Gathering is a technique passed on by the Inuzuka Clan that allows the User to gather the scent of the Ninja that is nearby the Inuzuka when it is used. Allowing the Inuzuka to track their location.","Ninjutsu");return
					if("Exploding Puppy")
					...
					if("Piercing Fang")
						...
						if(usr.Training<30)
							usr<<"You need more Training Passive(30)!";return
						if(usr.Canine<5)
							usr<<"You need more Canine Passive(5)!";return
					...
					if("Dual Piercing Fang")
						...
						if(usr.Training<35)
							usr<<"You need more Training Passive(35)!";return
						if(usr.Canine<10)
							usr<<"You need more Canine Passive(10)!";return
					...
					if("Double-Headed Wolf")
						...
						if(usr.Training<35)
							usr<<"You need more Training Passive(35)!";return
						if(usr.Canine<50)
							usr<<"You need more Canine Passive(50)!";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Aburame Clan") in list ("Insect Clone Jutsu","Kikaichuu Sheild","Insect Sphere","Insect Storm","Cancel"))
					if("Kikaichuu Sheild")
						if(usr.BugMastery<25)
							usr<<"You need more Bug Mastery(25).";return
					...
					if("Insect Clone Jutsu")
						if(usr.BugMastery<15)
							usr<<"You need more Bug Mastery.(15)";return
					...
					if("Insect Sphere")
						if(usr.BugKeeper<15)
							usr<<"You need more Bug Keeper(15).";return
					...
					if("Insect Storm")
						if(usr.BugKeeper<50)
							usr<<"You need more Bug Keeper(50).";return
...
//						usr.LearnJutsu("Doton; Dochu Eigyo No Jutsu",15,"Dochu Eigyo","Doton; Dochu Eigyo No Jutsu is a technique that allows the user to move freely underground.","Doton")
	...
	LeafJounin17
		...
		verb/Command()
			...
			if(usr.Village!="Leaf")
				return
			switch(input(usr,"Would you like to learn some techniques?", "Uzumaki Clan") in list ("Shadow Clone Attack","Windmill Clone Attack","Shadow Clone Punch","Double Rasengan","Giant Rasengan","Rasengan Barrage","Rasenshuriken","Cancel"))
				...
				if("Double Rasengan")
					if(usr.VMorale<125)
						usr<<"You are not committed enough to this village(125)!";return
					...
					if(usr.NinjutsuKnowledge<350)
						usr<<"You don't have enough knowledge with Ninjutsu Techniques(350)!";return
				...
				if("Rasengan Barrage")
					if(usr.VMorale<225)
						usr<<"You are not committed enough to this village(225)!";return
					...
					if(usr.NinjutsuKnowledge<1000)
						usr<<"You need more Ninjutsu Knowledge(1000)!";return
				...
				if("Giant Rasengan")
					...
					if(usr.Mchakra<8500)
						usr<<"You don't have enough chakra to learn this(8500).";return
				...
				if("Rasenshuriken")
					if(usr.VMorale<200)
						usr<<"You need 200 village morale to get this!";return
					if(usr.FuutonKnowledge<1000)
						usr<<"You need 1000 fuuton knowledge for this!";return
					usr.LearnJutsu("Rasenshuriken",100000,"Rasenshuriken","Rasenshuriken is powerful wind projectile capable of destroying massive structures!");return
...
//Rock Ninja/////////////////////////////////////////////
	RockJouninPuroresu
		...
		verb/Command()
			...
			var/list/A=usr.LearnedJutsus
			if(usr.TaijutsuStyle=="Basic")
				if(usr.Village!="Rock"&&usr.Clan!="Yotsuki")
					usr<<"You aren't a Rock Village. No way I'm teaching you this!"
					return
				if(usr.Village!="Rock"&&usr.Clan=="Yotsuki")
					usr<<"You might not be a Rock Villager...but you are of a clan that is special to me.... Let me teach you what your ancestors used long ago.."
				usr<<"Hm, it seems like I can teach you in that fighting style!"
				switch(input(usr,"To convert to the Puroresu, it requires vigorously fast reflexes and speed. Do you want to learn it?", "Puroresu") in list ("Yes","No"))
					if("Yes")
						if(usr.TaijutsuStyle=="Basic")
							usr.LearnJutsu("Puroresu",5000,"Puroresu","Puroresu is a taijutsu style that works with swift attacks and speed combined with Raw Power: It was also known to be used by Yotsukis years ago as a common fighting style.","Taijutsu")
					else
						return
			if(usr.TaijutsuStyle=="Puroresu")
				switch(input(usr,"Would you like to learn some techniques?", "Puroresu") in list ("Lariat","Guillotine Drop","Oppression Horrizontal Chop","Liger Bomb","Cancel"))
					if("Lariat")
						usr.LearnJutsu("Lariat",10000,"Lariat","The user charges at his opponent, striking them with a quick and agile move. The attack is rather straightforward, but very quick, powerful and is easily capable of knocking down an opponent.","Taijutsu");return
					if("Guillotine Drop")
						var/found=0
						for(var/obj/SkillCards/Lariat/P in A)
							if(P.type == /obj/SkillCards/Lariat) found=1
						if(!found)
							usr<<"You need to learn Lariat to use this jutsu!";return
						if(usr.TaijutsuKnowledge<35)
							usr<<"You need more Taijutsu Knowledge(35).";return
						usr.LearnJutsu("Guillotine Drop",15000,"GuillotineDrop","Guillotine Drop is a technique that allows the user to jump into the air above his opponent and performs a downwards kick, using the momentum of the fall to increase the power behind the attack..","Taijutsu");return
					if("Oppression Horrizontal Chop")
						var/found=0
						for(var/obj/SkillCards/GuillotineDrop/P in A)
							if(P.type == /obj/SkillCards/GuillotineDrop) found=1
						if(!found)
							usr<<"You need to learn Guillotine Drop to use this jutsu!";return

						if(usr.TaijutsuKnowledge<350)
							usr<<"You need more Taijutsu Knowledge(350).";return
						usr.LearnJutsu("Oppression Horrizontal Chop",25000,"HorizontalChop","Oppression Horrizontal Chop is a jutsu that allows the user to leaps from a high vantage point and performs a simple yet powerful horizontal chop on his opponent from above, seemingly using the momentum gained in the previous fall to increase the force behind his strike and continue driving it forward.","Taijutsu");return
					if("Liger Bomb")
						var/found=0
						for(var/obj/SkillCards/HorizontalChop/P in A)
							if(P.type == /obj/SkillCards/HorizontalChop) found=1
						if(!found)
							usr<<"You need to learn Oppression Horizzontal Chop to use this jutsu!";return
						if(usr.TaijutsuKnowledge<1200)
							usr<<"You need more Taijutsu Knowledge(1200).";return
						usr.LearnJutsu("Liger Bomb",50000,"LigerBomb","Liger Bomb is a technique that the Raikage from over 300 Years ago is known for using in battle along with his legendary Raikage Armor. The user grabs his opponents throat and holds them into the air. Then, using his extreme strength, he smashes them head first onto the ground in what resembles a powerbomb force. This is devastating enough to shatter a large area of the ground itself on impact, creating a giant crater in its wake.","Taijutsu");return
	RockJounin1
		name = "Mako"
		CNNPC = 1
		health = 9999999999999999999999999999999999999999999999
		...
		//				usr<<"You need more Village Morale!"
			...
			if(usr.BeginningVillage=="Rock")
				...
				switch(input(usr,"Would you like to learn a technique that allows you to blend in with your surroundings?","Meisai Gakure No Jutsu") in list ("Yes","No"))
					if("Yes")
						if(usr.VMorale<35)
							usr<<"You are not committed enough to this village(35)!";return
		...
		verb/Command()
			...
			if(!(locate(/obj/SkillCards/RockFlurry) in usr.LearnedJutsus))
				if(usr.VMorale>150)
					...
					usr<<"You need more Village Morale(150)!"
	Rock_Doton_Teacher
		name = "Juugo"
		CNNPC = 1
		health = 9999999999999999999999999999999999999999999999
...
//						usr.LearnJutsu("Doton; Dochu Eigyo No Jutsu",15,"Dochu Eigyo","Doton; Dochu Eigyo No Jutsu is a technique that allows the user to move freely underground.","Doton")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Sabaku Clan") in list ("Sand Eye","Sand Manipulation","Desert Coffin","Desert Funeral","Quicksand Waterfall Current","Desert Imperial Funeral","Sand Shuriken","Sand Clone","Sand Arm","SunaWhip","Sand Sphere","SabakuSandField","SabakuSandFieldBurial","Cancel"))
					...
					if("Sand Manipulation")
						if(usr.SandMastery<25)
							usr<<"You need more Sand Mastery(25).";return
					...
					if("Desert Coffin")
						if(usr.SandMastery<60)
							usr<<"You need more Sand Mastery(60).";return
					...
					if("Quicksand Waterfall Current")
						...
						if(usr.SandMastery<90)
							usr<<"You need more Sand Mastery(90).";return
					...
					if("Desert Imperial Funeral")
						if(usr.SandMastery<100)
							usr<<"You need more Sand Mastery(100).";return
					...
					if("Sand Shuriken")
						if(usr.SandMastery<5)
							usr<<"You need more Sand Mastery(5).";return
					...
					if("Sand Clone")
						if(usr.SandMastery<15)
							usr<<"You need more Sand Mastery(15).";return
					...
					if("Sand Arm")
						if(usr.SandMastery<35)
							usr<<"You need more Sand Mastery.(35)";return
						if(!usr.Shukaku)
					...
					if("Sand Sphere")
						if(usr.SandMastery<40)
							usr<<"You need more Sand Mastery(40).";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kiro Clan") in list ("Shuriken Control Jutsu","Chakra Shuriken","Shuriken Smithy Jutsu","Spiral Star","Spiraling Projectile","Shuriken Shield", "Void Star","Cancel"))
					...
					if("Chakra Shuriken")
						if(usr.ShurikenMastery<15)
							usr<<"You need more Shuriken Mastery(15).";return
					...
					if("Shuriken Smithy Jutsu")
						...
						for(var/obj/SkillCards/ChakraShuriken/P in A)
							if(P.type == /obj/SkillCards/ChakraShuriken)
								found2=1
							if(P.Uses<150)
								usr<<"You haven't mastered Chakra Shuriken yet(150 Uses)!";return
						if(!found2)
							usr<<"You need to learn Chakra Shuriken to use this jutsu!";return
	...
	RockJouninDust
		...
		health = 9999999999999999999999999999999999999999999999
		Village="Rock"
	//	icon='Icons/Jutsus/Nidaime Tsuchikage NPC.dmi'
		New()
			..()
			spawn()
				src.icon=null
	//			var/Base='Icons/Jutsus/Nidaime Tsuchikage NPC.dmi'
	//			Base+=rgb(235,145,52)
	//			src.icon=Base
		//		var/Base='Icons/New Base/Base.dmi'
				var/Base='Icons/Jutsus/Nidaime Tsuchikage NPC.dmi'
		...
		verb/Command()
			...
			if(!src in get_step(usr,usr.dir))
				usr<<"You need to be facing them!";return
			usr<<"Shoot for the dust, never the stars."
			sleep(3)
			var/list/A=usr.LearnedJutsus
			if(usr.Clan=="Kieru")
				usr<<"It seems you possess the hidden talents of the kekkai Tota...Let me help you further these talents.."
				switch(input(usr,"Would you like to learn some techniques?", "Kieru Clan") in list ("Jinton: Floating Speck","Jinton: Hakuri","Jinton: Genkai Hakuri",,"Cancel"))
					if("Jinton: Floating Speck")
						usr.LearnJutsu("Jinton: Floating Speck",7500,"FloatingSpeck","Jinton: Floating Speck is the first technique in the Dust Style. Allowing the user to create dust particles in the form of a large specticle, ramming into someone and damaging them due to the large quantity of dust put together.","Ninjutsu");return

					if("Jinton: Hakuri")
						if(usr.JintonIntensity<0.5)
							usr<<"You need more Jinton Intensity(0.5)";return
						usr.LearnJutsu("Jinton: Hakuri",35000,"JintonHakuri","Jinton: Hakuri is among the most popular of the Dust Style, being known to have been used a lot during the Fourth Great Ninja War. The user uses Dust Release to create a structure, with a sphere located at its centre, between the palms of his hands. The structure expands rapidly in size when being propelled towards its intended target and traps them inside its confines. The sphere then seems to explode with a tremendous amount of force, while the exterior walls of the structure effectively restrict the size of the blast radius, resulting in the destruction of everything and anyone caught within as they are pulverised into minute particles of dust. .","Ninjutsu");return
					if("Jinton: Genkai Hakuri")
						var/found2=0
						for(var/obj/SkillCards/JintonHakuri/P in A)
							if(P.type == /obj/SkillCards/JintonHakuri)
								found2=1
						if(!found2)
							usr<<"You need to learn Jinton: Hakuri to use this jutsu!";return
						usr.LearnJutsu("Jinton: Genkai Hakuri",100000,"JintonGenkaiHakuri","Jinton: Genkai Hakuri is a Kieru Clan Member's strongest technique. The user uses dust release to create a large amount of dust particles 100x greater than the amount gathered in Floating Speck. The user puts all of them together to create a large blast radius at the opponent. Easily demolishing them if caught in it in a matter of seconds.","Ninjutsu");return
	...
	RockJounin11
		...
		verb/Command()
			...
			if(usr.Clan=="Iwazuka")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Iwazuka") in list ("C1","C2","C3","Spikes","C4","Clay Carrier","C0","ClaySenbon","Mines","Grasshoppers","Flower","Spear","Spider","Bird","Cancel"))
					if("C1")
					...
					if("C2")
						...
						if(usr.ExplosiveMastery<25)
							usr<<"You need more Explosive Mastery(25)!";return
					...
					if("C3")
						...
						if(usr.ExplosiveMastery<75)
							usr<<"You need more Explosive Mastery(75)!";return
					...
					if("Spikes")
						...
						if(usr.ExplosiveMastery<80)
							usr<<"You need more Explosive Mastery(80)!";return
						usr.LearnJutsu("Clay Spikes",25000,"Spikes","Clay Spikes are extremely lethal and sharp that allow the Iwazuka to click on an area and depending on the location, detonate a quick and lethal spike!","Ninjutsu");return
					if("C4")
						var/found2=0
						for(var/obj/SkillCards/Spikes/P in A)
							if(P.type == /obj/SkillCards/Spikes)
								found2=1
						if(!found2)
							usr<<"You need to learn to use Spikes first!";return
						if(usr.ExplosiveMastery<100)
							usr<<"You need more Explosive Mastery(100)!";return
					...
					if("ClaySenbon")
						usr.LearnJutsu("ClaySenbon",10000,"ClaySenbon","Art is an EXPLOSION!","Ninjutsu")
					if("Mines")
						usr.LearnJutsu("ClayMine",10000,"ClayMine","Art is an EXPLOSION!","Ninjutsu")
					if("Grasshoppers")
						usr.LearnJutsu("ClayGrasshopper",10000,"ClayGrasshopper","Art is an EXPLOSION!","Ninjutsu")
					if("Flower")
						usr.LearnJutsu("ClayFlower",10000,"ClayFlower","Art is an EXPLOSION!","Ninjutsu")
					if("Spear")
						usr.LearnJutsu("ClaySpear",10000,"ClaySpear","Art is an EXPLOSION!","Ninjutsu")
					if("Spider")
						usr.LearnJutsu("ClaySpider",10000,"ClaySpider","Art is an EXPLOSION!","Ninjutsu")
					if("Bird")
						usr.LearnJutsu("ClayBird",10000,"ClayBird","Art is an EXPLOSION!","Ninjutsu")
		...
		verb/Command()
			...
			if(usr.Village=="Rock"&&usr.BeginningVillage=="Rock")
				switch(input(usr,"I hold the concentration for Rock Village's teleportation jutsu. It's developed as a defence for our ninja and can be used anytime. I can teach you the technique?", "Renden Teleporation") in list ("Yes","No"))
					if("Yes")
						if(usr.NinjutsuKnowledge<50)
							usr<<"You need more Ninjutsu Knowledge(50).";return
		...
		verb/Command()
			...
			if(usr.Village=="Rain")
				switch(input(usr,"Weather is such a drag without mist,lags,and blood! Wanna learn some stuff?", "Kirigakure No Jutsu") in list ("Teach me Rain","Teach me to Locate","Teach me Mist","Teach me to Poison...","Teach me to Kill...","Teach me to make it Rain Blood...","No"))
					if("Teach me Mist")
						if(usr.VMorale<90)
							usr<<"You are not committed enough to this village(90)!";return
						if(usr.NinjutsuKnowledge<15)
							usr<<"You need more Ninjutsu Knowledge(15).";return
					...
					if("Teach me Rain")
						if(usr.VMorale<100)
							usr<<"You are not committed enough to this village(100)!";return
						if(usr.NinjutsuKnowledge<150)
					...
					if("Teach me to Poison...")
						...
						if(usr.PoisonKnowledge<25)
							usr<<"You don't know enough about poisons to learn this(25)!";return
				...
				//		usr.LearnJutsu("Poisoning Rain",35000,"PoisonRain","Poisoning Rain is a jutsu that creates a rain of deadly poison that harms people as it soaks them wet...","Ninjutsu");return
					if("Teach me to Locate")
						if(usr.VMorale<125)
							usr<<"You are not committed enough to this village(125)!";return
						if(usr.NinjutsuKnowledge<200)
							usr<<"You need more Ninjutsu Knowledge(200).";return
				//		usr.LearnJutsu("Raveling Rain",50000,"RavelRain","Raveling Rain is a jutsu that creates a rain enfused with your own chakra and allows you to know if the rain has drenched anyone, allowing you to know if anybody is nearby.","Ninjutsu");return
					if("Teach me to Kill...")
						if(usr.VMorale<200)
							usr<<"You are not committed enough to this village(200)!";return
						if(usr.NinjutsuKnowledge<200&&usr.TaijutsuKnowledge<450)
							usr<<"You need more Ninjutsu Knowledge or Taijutsu Knowledge(200 Ninjutsu Knowledge and 450 Taijutsu Knowledge)!";return
					...
					if("Teach me to make it Rain Blood...")
						if(usr.SenbonMastery<30)
							usr<<"You aren't proficient enough with Senbons to learn this technique..(30 Senbon Mastery)";return
						if(usr.VMorale<150)
							usr<<"You are not committed enough to this village(150)!";return
		...
		verb/Command()
			...
			if(usr.Clan=="Shiroi")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Shiroi Clan") in list ("Yuki Shuriken","Sensatsu Suishou","Aisu Sawarabi","Ice Creation","Makyou Hyoushou","Cancel"))
					...
					if("Sensatsu Suishou")
						if(usr.IceRush<15)
							usr<<"You don't have enough Ice Rush(15).";return
					...
					if("Aisu Sawarabi")
						if(usr.IceRush<45)
							usr<<"You don't have enough Ice Rush(45).";return
					...
					if("Makyou Hyoushou")
						if(usr.IceRush<50)
							usr<<"You don't have enough Ice Rush(50).";return
				...
				switch(input(usr,"", "") in list ("He did?","I don't care"))
					if("He did?")
						...
						switch(input(usr,"", "") in list ("Wanna learn it?","Nevermind"))
							if("Wanna learn it?")
								if(usr.VMorale<=300)
									usr<<"I don't think you appreciate your village enough to learn this...(300)"
									return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kumojin Clan") in list ("Spider Cobweb Flower","Spider Sticky Gold(Kunai)","Armor of Sticky Gold","Spider War Bow","Flowering Web","Giant Web Capture Field","Cancel"))
					if("Spider Cobweb Flower")
						if(usr.WebMastery<35)
							usr<<"You need more Web Mastery.(35)";return
					...
					if("Armor of Sticky Gold")
						...
						if(usr.SpiderMastery<25)
							usr<<"You need more Spider Mastery.(25)";return
					...
					if("Spider War Bow")
						...
						if(usr.SpiderMastery<75)
							usr<<"You need more Spider Mastery(75).";return
					...
					if("Flowering Web")
						if(usr.SpiderMastery<40)
							usr<<"You need more Spider Mastery(40).";return
					...
					if("Giant Web Capture Field")
						if(usr.SpiderMastery<49)
							usr<<"You need more Spider Mastery(49).";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kaguya Clan") in list ("Bone Bullets","Bone Membrane","Dance of the Willow","Dance of the Camellia","Dance of the Larch","Dance of the Clematis","Cancel"))
					...
					if("Dance of the Willow")
						if(usr.BoneMastery<15)
							usr<<"You don't have enough Bone Mastery(15).";return
					...
					if("Dance of the Camellia")
						...
						if(usr.DanceMastery<15)
							usr<<"You don't have enough Dance Mastery(15).";return
					...
					if("Dance of the Larch")
						...
						if(usr.BoneMastery<35)
							usr<<"You don't have enough Bone Mastery(35).";return
						if(usr.DanceMastery<20)
							usr<<"You don't have enough Dance Mastery(20).";return
					...
					if("Dance of the Clematis")
						...
						if(usr.BoneMastery<65)
							usr<<"You don't have enough Bone Mastery(65).";return
						if(usr.DanceMastery<30)
							usr<<"You don't have enough Dance Mastery(30).";return
					...
					if("Departure In Flames")
						if(locate(/obj/SkillCards/Anarchist) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<400)
								usr<<"You need more Taijutsu Knowledge(400).";return
							if(usr.Kenjutsu<5)
								usr<<"You need more Kenjutsu.(5)";return
					...
					if("Kaitengiri")
						if(locate(/obj/SkillCards/DepartureInFlames) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<450)
								usr<<"You need more Taijutsu Knowledge(450).";return
							if(usr.Kenjutsu<8)
								usr<<"You need more Kenjutsu Knowledge(8).";return
					...
					if("Anzentaru Eiketsu")
						if(locate(/obj/SkillCards/Kaitengiri) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<550)
								usr<<"You need more Taijutsu Knowledge(550).";return
							if(usr.Kenjutsu<15)
								usr<<"You need more Kenjutsu Knowledge(15)!";return
					...
					if("Sanjuuken")
						if(locate(/obj/SkillCards/AnzentaruEiketsu) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<550)
								usr<<"You need more Taijutsu Knowledge(550).";return
							if(usr.Kenjutsu<25)
								usr<<"You need more Kenjutsu Knowledge(25)!";return
					...
					if("Taiatari")
						if(locate(/obj/SkillCards/Sanjuuken) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<750)
								usr<<"You need more Taijutsu Knowledge(750).";return
							if(usr.Kenjutsu<35)
								usr<<"You need more Kenjutsu Knowledge(35).";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kaguya Clan") in list ("Dance of the Seedling Fern","Dance of the Seedling Fern Advanced","Cancel"))
					if("Dance of the Seedling Fern")
						...
						if(usr.BoneMastery<100)
							usr<<"You don't have enough Bone Mastery(100).";return
						if(usr.DanceMastery<30)
							usr<<"You don't have enough Dance Mastery(30).";return
					...
					if("Dance of the Seedling Fern Advanced")
						...
						if(usr.BoneMastery<99)
							usr<<"You don't have enough Bone Mastery(99).";return
						if(usr.DanceMastery<9)
							usr<<"You don't have enough Dance Mastery(9).";return
...
//				var/list/A=usr.LearnedJutsus
	...
	SoundJounin11
		...
		verb/Command()
			...
			if(!src in get_step(usr,usr.dir))
				usr<<"You need to be facing them!";return
			if(usr.CursedSealType=="Attempted")
				usr<<"You aren't capable of achieving cursed seal.";return
			usr<<"Hmm, sure is nice out here isn't it? I come here to get away from it all and practice this Forbidden skill."
			if(!(locate(/obj/SkillCards/CursedSealActivation) in usr.LearnedJutsus))
				...
				//			var/Chance=10
					...
					//			Chance-=15
							if(prob(Chance))
								usr<<"Your body wasn't capable of achieving the Cursed Seal"
								usr.CursedSealType="Attempted"
								usr.AutoSave()
								usr.SaveK()
				...
				switch(input(usr,"Would you like to learn some techniques?", "Rakanken Ryuu") in list ("Asshou","Chou Asshou","Hoshou","Shoushitzu","Flash Kick","Drop Kick","Cancel"))
					...
					if("Hoshou")
						...
						if(usr.TaijutsuKnowledge<650)
							usr<<"You need more Taijutsu Knowledge(650).";return
					...
					if("Flash Kick")
						if(usr.TaijutsuKnowledge<1100)
							usr<<"You need more Taijutsu Knowledge(1100).";return
					...
					if("Drop Kick")
						if(usr.TaijutsuKnowledge<1100)
							usr<<"You need more Taijutus Knowledge(1100).";return
					...
					if("Eternal Defence")
						if(locate(/obj/SkillCards/ReactionBelow) in usr.LearnedJutsus)
							if(usr.TaijutsuKnowledge<950)
								usr<<"You need more Taijutsu Knowledge(950).";return
	...
	//				found=2
			...
			if(found==3)
				if(usr.GenjutsuKnowledge<=550)
					usr<<"You need more genjutsu knowledge to learn this technique(550).";return
				...
				if(usr.GenjutsuKnowledge<=450)
					usr<<"You need more genjutsu knowledge to learn this technique(450).";return
				...
				switch(input(usr,"Kokuangyo is a powerful genjutsu. Would you like to learn it?", "Kokuangyo") in list ("Yes","No"))
					if("Yes")
						if(usr.GenjutsuKnowledge<35)
							usr<<"You need more Genjutsu Knowledge(35).";return
			...
			switch(input(usr,"Brrr, I'm cold. How cold are you?", "Buriza-do") in list ("Really Cold","What?"))
				if("Really Cold")
					...
					for(var/obj/SkillCards/Burizado/P in A)
						found=1
					for(var/obj/SkillCards/AOEBurizado/P in A)
						found=2
					if(found==2)
						for(var/obj/SkillCards/Kokuangyo/P in A)
							found=3
					if(found==0)
						usr.LearnJutsu("Buriza-do",10000,"Burizado","Buriza-do No Jutsu is a technique which covers the opponent in a blizzard, causing them to move slow! Because it is a genjutsu, only they can see it and only they think it's real","Genjutsu");return
					...
					else if(found==3&&usr.GenjutsuKnowledge>650)
						if((usr.GenSkill+(usr.ChakraC/25))>=21)
		...
		verb/Command()
			...
			switch(input(usr,"Illusions!!!", "Kasumi") in list ("I see them too!","What?"))
				if("I see them too!")
					if(usr.GenjutsuKnowledge<35)
						usr<<"You need more Genjutsu Knowledge(35).";return
					usr.LearnJutsu("Kasumi Juusha No Jutsu",15000,"Kasumi","Kasumi Juusha No Jutsu is a genjutsu technique that creates false clones, allowing you to move around freely and secretly.","Genjutsu");return
	MissingJounin8
		name = "Irela"
		icon_state="NPC2"
		CNNPC=1
			...
			switch(input(usr,"Yawn...", "Nehan Shouja no Jutsu") in list ("Are you tired?","What?"))
				if("Are you tired?")
					if(usr.GenjutsuKnowledge<50)
						usr<<"You need more Genjutsu Knowledge(50).";return
					usr.LearnJutsu("Nehan Shouja no Jutsu",20000,"Nemurihane","Nehan Shouja no Jutsu is a technique that covers the whole field with petals, anyone in it automatically falling asleep.","Genjutsu");return
	MissingJounin40
		name = "Gyoushino"
		icon_state="NPC2"
		CNNPC=1
		...
		verb/Command()
			...
			switch(input(usr,"Look Into My Eyes...Are you Scared..?") in list ("...","No"))
				if("...")
					if(usr.GenjutsuKnowledge<10)
						usr<<"You need more Genjutsu Knowledge, come back to me when you have more...(10)";return
					usr.LearnJutsu("Gaze Of Horror",2000,"GazeOfFear","Gaze Of Fear is a Genjutsu that requires the User to look into the eyes of the opponent, terrifying them and reducing their stats temporarily.","Genjutsu")
					return
	MissingJounin41
		name = "Kado"
		icon_state="NPC2"
			...
			switch(input(usr,"Have you ever been to another Dimension...Who knows what lies on the other side...") in list ("I want to find out...","Who knows"))
				if("I want to find out...")
					if(usr.GenjutsuKnowledge<650)
						usr<<"You need more Genjutsu Knowledge, come back to me when you have more...(650)";return
			...
			switch(input(usr,"Genjutsu utilizing Ninja Tools is a deadly combination..") in list ("How So?","Ok."))
				if("How So?")
					if(usr.GenjutsuKnowledge<650)
						...
						usr<<"You need more knowledge with Kunais to learn this Genjutsu..(30)";return
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kusakin Clan") in list ("Seasonal-Edged Leaf Jutsu","Ivy-Whip Jutsu","VineFieldJutsu","Grass-Knot Jutsu","Ivy-Forest Jutsu","Cancel"))
					...
					if("Ivy-Whip Jutsu")
						if(usr.GrassMastery<35)
							usr<<"You need more Grass Mastery to learn this jutsu.(35)";return
					...
					if("VineFieldJutsu")
						if(usr.GrassMastery<75)
							usr<<"You need more Grass Mastery to learn this jutsu.(75)";return
					...
					if("Grass-Knot Jutsu")
						if(usr.GrassMastery<50)
							usr<<"You need more Grass Mastery to learn this jutsu.(50)";return
	...
	MissingJounin10
		...
		verb/Command()
			...
			if(usr.Clan=="Kusakin")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Kusakin Clan") in list ("Wood Barrier Jutsu","Tree Melding","Birth of a Dense Woodland Jutsu","Wood Spikes Jutsu","Cancel"))
					...
					if("Tree Melding")
						usr.LearnJutsu("Tree Melding",20000,"TreeMelding","Wood Style: Tree Melding is a jutsu that is only possible due to the Kusakin's control of Mokuton and wood. The Kusakin senses the wood of a nearby tree and merges their chakra with it, allowing the Kusakin to swiftly go through the ground and amerge to the location of the tree.","Mokuton");return
	...
	MissingJounin11
		...
		verb/Command()
			...
			if(usr.Clan=="Ketsueki")
				...
				switch(input(usr,"Would you like to learn some techniques?", "Ketsueki Clan") in list ("Blood Clone Jutsu","1st Seal","2nd Seal","3rd Seal","4th Seal","5th Seal","6th Seal","7th Seal","Cancel"))
					...
					if("2nd Seal")
						if(usr.SealMastery<25)
							usr<<"You need more Seal Mastery to learn this technique.(25)";return
					...
					if("3rd Seal")
						if(usr.SealMastery<35)
							usr<<"You need more Seal Mastery to learn this technique.(35)";return
					...
					if("4th Seal")
						if(usr.SealMastery<45)
							usr<<"You need more Seal Mastery to learn this technique.(45)";return
					...
					if("7th Seal")
						if(usr.SealMastery<45)
							usr<<"You need more Seal Mastery to learn this technique.(45)";return
						usr.LearnJutsu("Fuuin: Seventh Seal",75000,"SeventhSeal","Seventh Seal is a technique that allows the Ketsueki to convert their chakra supply as it flows through their blood stream into a replenishing solutent, healing the user at the cost of chakra.","Ninjutsu");return
	...
	*/
	...
	BarrierTeacher
		...
		verb/Command()
			...
			if(usr.GenSkill<=19)
				usr<<"Sorry you're incapable of preforming the construct arts!"
			sleep(20)
			switch(input(usr,"Would you like to learn some Defencive Techniques?", "Barrier Ninjutsu") in list ("Chakra Barrier","Strengthened Chakra Barrier","Barrier Entrapment","Chakra Barrier Shielding","Chakra Barrier Containment","Chakra Barrier Rising Trail","Chakra Barrier Destructive Containment","Cancel"))
				if("Chakra Barrier")
					if(usr.NinjutsuKnowledge<=150)
				...
				if("Strengthened Chakra Barrier")
					...
					usr.LearnJutsu("Enhanced Chakra Barrier",10000,"ChakraBarrierBig","Enhanced Chakra Barrier is a jutsu that is created by using what you learned from Chakra Barrier but manipulating the chakra to a more advanced state, creating a much bigger shield to protect against attacks.","Ninjutsu");return
				...
				if("Barrier Entrapment")
					...
					usr.LearnJutsu("Barrier Entrapment",15000,"ChakraBarrierTrap","Barrier Entrapment may be considered an offencive or Countering Ninjutsu but it still utilizes the defencive properties of A Chakra Barrier. Barrier entrapment causes created barriers to form around an opponent, sealing them in while also protecting them.","Ninjutsu");return
				if("Chakra Barrier Shielding")
					...
					usr.LearnJutsu("Chakra Barrier Shielding",15000,"ChakraBarrierShield","Chakra Barrier Shield allows the user to create chakra shield in all four directions around them, encasing them in a more defencive formation.","Ninjutsu");return
				if("Chakra Barrier Containment")
					if(usr.GenSkill<25)
						usr<<"Sorry. I don't think you have enough natural control with your Chakra...";return
					if(usr.NinjutsuKnowledge<=475)
						usr<<"You need at least 475 Ninjutsu Knowledge. Current Ninjutsu Knowledge: [usr.NinjutsuKnowledge].";return
					if(!(locate(/obj/SkillCards/ChakraBarrierShield) in usr.LearnedJutsus))
						usr<<"You Need to Learn Barrier Shielding First!";return
					usr.LearnJutsu("Chakra Barrier Containment",20000,"ChakraBarrierContainment","Chakra Barrier Containment allows the user to create a chakra shield cage around them, encasing them in a more arena type formation.","Ninjutsu");return
				if("Chakra Barrier Rising Trail")
					if(usr.GenSkill<30)
						usr<<"Sorry. I don't think you have enough natural control with your Chakra...";return
					if(usr.NinjutsuKnowledge<=475)
						usr<<"You need at least 475 Ninjutsu Knowledge. Current Ninjutsu Knowledge: [usr.NinjutsuKnowledge].";return
					if(!(locate(/obj/SkillCards/ChakraBarrierContainment) in usr.LearnedJutsus))
						usr<<"You Need to Learn other barrier jutsu first!";return
					usr.LearnJutsu("Chakra Barrier Rising Trail",10000,"ChakraBarrierRisingTrail","Creates a defensive trail behind your target!","Ninjutsu");return
				if("Chakra Barrier Destructive Containment")
					if(usr.GenSkill<30)
						usr<<"Sorry. I don't think you have enough natural control with your Chakra...";return
					if(usr.NinjutsuKnowledge<=575)
						usr<<"You need at least 575 Ninjutsu Knowledge. Current Ninjutsu Knowledge: [usr.NinjutsuKnowledge].";return
					if(!(locate(/obj/SkillCards/ChakraBarrierRisingTrail) in usr.LearnedJutsus))
						usr<<"You Need to Learn other barrier jutsu first!";return
					usr.LearnJutsu("Chakra Barrier Destructive Containment",50000,"ChakraBarrierDestructiveContainment","Crush them without mercy!","Ninjutsu");return
	WhiteElder
					...
					switch(input(usr,"The Hydro Form is a powerful Kinjutsu, and there is the possibilty of dying permanently. Will you risk learning it?", "") in list ("Yes","No"))
						...
						//		chance-=10
							if(prob(chance) && usr.ckey!="itsnothim")
								usr<<"You succumb to the pain and feel the life inside of you slipping away. You feel... wet..."
								...
								usr << "You've been majorly damaged!"
								usr.health-=2000
								usr.deathcount+=25
								return
							else
...
//	world<<"Your current amount of EP you are going to lose: [src.ElementalPointDeduction]."
	...
	switch(input(src,"[JutsuDesc]            Training Requirements: [Cost] EXP", "[JutsuName]") in list("Yes","No","Cancel"))
		if("Yes")
			...
			if(src.TaijutsuStyle!="Basic")
				if(JutsuMemoryVar=="Gouken"||JutsuMemoryVar=="Puroresu"||JutsuMemoryVar=="Enjouhawa"||JutsuMemoryVar=="Rakanken"||JutsuMemoryVar=="Quick Fist"||JutsuMemoryVar=="Hansha")
					return
			if(JutsuMemoryVar!="Genjutsu Kai"&&JutsuMemoryVar!="Gouken"&&JutsuMemoryVar!="Puroresu"&&JutsuMemoryVar!="Enjouhawa"&&JutsuMemoryVar!="Rakanken"&&JutsuMemoryVar!="Initial Gate"&&JutsuMemoryVar!="Heal Gate"&&JutsuMemoryVar!="Life Gate"&&JutsuMemoryVar!="Wound Gate"&&JutsuMemoryVar!="Limit Gate"&&JutsuMemoryVar!="View Gate"&&JutsuMemoryVar!="Quick Fist"&&JutsuMemoryVar!="FireChakra"&&JutsuMemoryVar!="WaterChakra"&&JutsuMemoryVar!="WindChakra"&&JutsuMemoryVar!="LightningChakra"&&JutsuMemoryVar!="EarthChakra"&&JutsuMemoryVar!="Tero Hasaki"&&JutsuMemoryVar!="Hansha"&&JutsuMemoryVar!="EternalDefence")
