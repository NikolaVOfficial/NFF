...
mob/NPC/MerchantNPCs//Merchant System in developement//Just so you know where they are on the map.
	...
	proc/CommandThing(mob/usr)
		...
		if(usr.Village!=src.Village&&src.Village!="None"&&src.name!="Snack Vending Machine(NPC)"&&src.name!="Vegan Vending Machine(NPC)")	//Anyone can buy from None Village NPCs
...
//Creating skin color
				...
				//	if(LeafInDepression==1) usr<<"There are no items to be sold due to the depression.";return
					...
					src.InventorySet+=new/obj/BuyableThings/Weapons/SideShuriken3
					src.InventorySet+=new/obj/BuyableThings/Weapons/Shuriken
					src.InventorySet+=new/obj/BuyableThings/Weapons/SideShuriken8
...
//////////////////////////////////////////////////////
	...
	RockVillage//All of the NPCs that belong to Rock place under here.
		...
		Puppet_Salesman
			name="Puppet Salesman(NPC)"
			VillageSeller=1
			New()
				.=..()
				spawn()
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Puppet_Master_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Puppet_Swap_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Puppet_View_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Puppet_Return_Scroll
		...
		Puppet_Salesman_Two
			name="Puppet Parts Salesman(NPC)"
			VillageSeller=1
			New()
				.=..()
				spawn()
		...
		NinjaCashMerchant
			...
			New()
				...
				spawn()
					...
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Scrolls/Age_Scroll
					...
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/DarkBlade
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/LightBlade
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/Evanesence
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/RoseBladeSword
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/InvisibleKaito
					src.InventorySet+=new/obj/BuyableThings/NinjaCash/Weapons/Shibuki
					src.InventorySet+=new/obj/BuyableThings/Cancel
					//NPC Looks
					src.icon=null;var/Base='Icons/New Base/Base.dmi'
					Base+=rgb(235,145,52);src.icon=Base
