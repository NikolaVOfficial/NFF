...
mob/proc/UpdateLog()
	...
	var/updates = {"
		...
		<body bgcolor=#FFFFFF text=black>
		<center><h2>The Shinger was here List</h2></center>
		</br><b>Update Log!</b>
		<br>Skills can no longer be chained multiple times per tick
		<br>Death Avoiding now leaves your character online for 100 seconds (beta)
		<br>Fixed genjutsu causing server spikes
		<br>Fixed fire leaving icones everywhere!
		<br>Fixed Fire resist!
		<br>Fixed various katons burning the user uncontrollably!
		<br>Kyoumou additions(3 application methods and 6 particle effects(tier6&7))
		<br>Hoshikage tweaks
		<br>Kusakin spikes nerfed
		<br>Kusakin razor leaf tweaked
		<br>Kusakin forest given a larger cooldown
		<br>Kusakin forest can only spawn 20 trees
		<br>Kusakin tree spawning nerfed
		<br>Fixed raiton dragon
		<br>fixed water dragon speed
		<br>Jutsu banning system
		<br>Rasenshuriken nerfed
		<br>added my personal tornado soon to be ultimate for fuuton users
		<br>tweaked calorie drains
		<br>tweaked scroll prices
		<br>mist rain lower cooldown and can more easily be toggled
		<br>majestic eyes fixed
		<br>cursed seal currently in various works of getting fixed
		<br>Barriers rework
		<br>Guiding weapon is op(use it when someone is targeted ;o)
		<br>Astral projection jutsu set added
		<br>kage bunshin jutsu delete when killed
		<br>crows fixed
		<br>kunai summoning fixed(maybe have a bug i know the highest mastery is fixed)
		<br>Rearranged the medical tree
		<br>genkai hakuri and sand tsunami no longer stack on walls
		<br>Amateratsu buffed/tweaked
		<br>Genjutsu training buffed for low knowledge users
		<br>AOE gens use less chakra
		<br>Scalpels use less chakra
		<br>Rock armors use less chakra
		<br>Karakuri cooldown tweaked
		<br>Aging fixed
		<br>implemented Age refund system to recover lost stats
		<br>Aging tells stats
		<br>Nara's Nui jutsu fixed
		<br>kumojin spiders die easily now
		<br>various 64 palm bugs fixed(ik one more exist)
		<br>reppushou made to work better
		<br>Eye of kagura fixed
		<br>chakra no longer drains and only uses chakra when using radar
		<br>Radar only uses C button
		<br>Shousen reworked
		<br>Guard no longer stacks endurance
		<br>Multiclan bug fixed
		<br>doujutsu issue fixed
		<br>Food calorie gain increased
		<br>Tons of knockback nerfs...
		<br>Hokage Suit now actually gives armor...
		<br>Daibakufu nerfed a bit
		<br>Icons can be uploaded for 500k, BYOND members cost 1 yen/ryo, staff free
		<br>Bone Sage nerfed majorly
		<br>C2 knockback nerfed
		<br>C2 damage increased
		<br>Blocking vit from C2 increased
		<br>Rasenshuriken added as a leaf village jutsu!
		<br>Kage suits are now better than anbu gear
		<br>Fixed webs and syrup?
		<br>Lowered iwazuka carrier chakra cost
		<br>Fixed a trait issue causing u to not get a trait
		<br>Auras, hidden mist, and ice sawa are visible
		<br>Shoushitsu given longer cd
		<br>Beds were redone to avoid abuse
		<br>Fixed movement and attacking?
		<center><h2>May 28th - June 1st</h2></center>
		</br><b>Update Log!</b>
...
mob/proc/CheckMap()
	if(!src.client)
		return//
	var/Link="https://cdn.discordapp.com/attachments/596115260256026632/596328205649182732/Map.png"
